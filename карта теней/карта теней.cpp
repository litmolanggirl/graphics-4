...
public:
    ...
    bool Init()
    {
        ...
        m_pGroundTex = new Texture(GL_TEXTURE_2D, "C:/Content/bricks.jpg");
        ...
        return m_pMesh->LoadMesh("C:/Content/spider.obj");
    }
    ...
    virtual void ShadowMapPass()
    {
        ...
        p.WorldPos(sinf(m_scale / 50) * 15, 0.0f, 3.0f);
